public class ObjectListTest {
    ...
    public static void testContains() {
        ...
        System.out.println("Contains obj1: " + list.contains(obj1)); // Expected: true
        System.out.println("Contains obj2: " + list.contains(obj2)); // Expected: true
        System.out.println("Contains new Object: " + list.contains(new Object())); // Expected: false
        System.out.println();
    }
