public class Person{
    ...
    // class methods 
    //this is a class method that receives a parameter Person. Person is the new data type
    //for class method we need to use the object person, such as: Person1.equalTo(Person2);
    ...
    //for class method we need to use the object person, such as: Person1.equalTo(Person2);
    //this is an example, but the best way to write this method is return a boolean or person's name
