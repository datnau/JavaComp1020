...
// //get a new Person array. Copy the array, but the objects are pointing to the same reference
//     Person[] others1 = new Person[people.length];
// 	System.arraycopy(people, 0, others, 0, people.length);
    

// //most of the time, we want a deep copy. So, we need a loop to clone the objects
